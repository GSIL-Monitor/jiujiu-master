...
public class MailUtil {
    ...
    public static void main(String[] args) {
        ...
        String from = "liuzhijie@hanxinbank.com";
        String to = "lianyifan@hanxinbank.com";
        String subject = "哈哈";
        String content = "这是发送给你的测试的文本";
        String username = "liuzhijie@hanxinbank.com";
        String password = "Starry_245711031";
